 ...
 * 描述：自定义网格布局相册行程码图片适配器
 *
 * @author ZSAndroid
 * @create 2021-12-04-23:10
 */
public class GridRunCodeImageAdapter extends RecyclerView.Adapter<GridRunCodeImageAdapter.ViewHolder> {
    ...
    public GridRunCodeImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
