 ...
 */
public class BaseCanteenStoreInfoAdapter extends BaseQuickAdapter<StoreInfoBean, BaseViewHolder> implements LoadMoreModule, DraggableModule, UpFetchModule {
     ...
     */
    public BaseCanteenStoreInfoAdapter(int layoutResId) {
        super(layoutResId);
    }

    public BaseCanteenStoreInfoAdapter(int layoutResId, @Nullable List<StoreInfoBean> data) {
