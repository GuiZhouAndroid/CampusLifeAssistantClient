 ...
 */
public class CustomLongSHanFilterDrawerPopupView extends DrawerPopupView {
    TextView text;

    public CustomLongSHanFilterDrawerPopupView(@NonNull Context context) {
        super(context);
    }

    @Override
    protected int getImplLayoutId() {
        return R.layout.custom_drawer_popup_filter_long_shan;
    }
