...
public class CanteenLongSHanFragment extends BaseFragment {
    ...
    protected void initView(View rootView) {
        ...
        //初始化列表和监听
        mRecyclerViewLongSHan.setLayoutManager(new LinearLayoutManager(getActivity()));
        mRecyclerViewLongSHan.setItemAnimator(new DefaultItemAnimator());
        mRecyclerViewLongSHan.setAdapter(mAdapter = new BaseRecyclerAdapter<Model>(loadModels(), R.layout.activity_repast_practice_rcy_view_item) {
            @Override
        ...
        mRefreshLayoutLongSHan.setOnRefreshLoadMoreListener(new OnRefreshLoadMoreListener() {
            @Override
