package work.lpssfxy.www.campuslifeassistantclient.base.pogress;
...
import work.lpssfxy.www.campuslifeassistantclient.base.circleprogress.MiscUtil;
...
public class WaveProgress extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mCircleColor = typedArray.getColor(R.styleable.WaveProgress_circleColor, getResources().getColor(R.color.colorAccent));
