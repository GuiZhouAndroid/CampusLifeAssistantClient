 ...
 */
public class GridAddGoodsImageAdapter extends RecyclerView.Adapter<GridAddGoodsImageAdapter.ViewHolder> {
    ...
    public GridAddGoodsImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public void remove(int position) {
        ...
        if (GoodAddActivity.imgPathAddGoods != null) {
            GoodAddActivity.imgPathAddGoods = null;
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.custom_apply_run_gv_filter_image, viewGroup, false);
